...
def test_enforcement_engine():
    ...
    print("[PASS] Enforcement engine: Block action test passed")
...
def test_enforcement_gateway():
    ...
    print("[PASS] Enforcement gateway: Request check test passed")
...
def test_executor_runtime():
    ...
    print("[PASS] Executor runtime: Execution test passed")
